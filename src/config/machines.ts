...
export const SUSTRATOS = [
  ...
  { label: 'Papel Metalizado', precio_usd_m2: 0.95 },
  { label: 'BOPP White', precio_usd_m2: 0.92 },
  { label: 'BOPP Clear', precio_usd_m2: 0.85 },
  { label: 'BOPP Metalizado', precio_usd_m2: 1.05 },
  { label: 'BOPP Clear C/PET', precio_usd_m2: 1.10 },
  { label: 'BOPP White Hot Melt', precio_usd_m2: 1.15 },
  { label: 'PE White', precio_usd_m2: 0.98 },
  { label: 'PE Clear', precio_usd_m2: 0.90 },
  { label: 'PE Metalizado', precio_usd_m2: 1.08 },
  { label: 'PET White', precio_usd_m2: 1.2 },
  { label: 'PET Clear', precio_usd_m2: 1.15 },
  { label: 'PET Metalizado', precio_usd_m2: 1.35 },
  { label: 'Vellum', precio_usd_m2: 0.75 },
  { label: 'Yupo', precio_usd_m2: 1.45 },
  { label: 'Teslin', precio_usd_m2: 1.55 },
  { label: 'Mylar', precio_usd_m2: 1.60 },
  { label: 'Kromekote', precio_usd_m2: 0.8 },
  { label: 'Dull Silver', precio_usd_m2: 1.1 },
  { label: 'Allure Diamond', precio_usd_m2: 1.8 },
  { label: 'AGAVE', precio_usd_m2: 2.1 },
